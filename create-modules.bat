...
npx nx g @nx/angular:host workspace --add-tailwind --directory=modules/workspace --prefix=workspace --style=scss --e2eTestRunner=cypress --projectNameAndRootFormat=as-provided
